...
# Coral使用の場合はmake_interpreter、未使用の場合はInterpreter(解釈)
...
def main():
  ...
  parser.add_argument('-m', '--model', default='mobilenet_v2_1.0_224_inat_plant_quant_edgetpu.tflite',
                      help='File path of .tflite file.')
  parser.add_argument('-i', '--input', default='yellow-water-lily.jpeg',
                      help='Image to be classified.')
  parser.add_argument('-l', '--labels', default='inat_plant_labels.txt',
