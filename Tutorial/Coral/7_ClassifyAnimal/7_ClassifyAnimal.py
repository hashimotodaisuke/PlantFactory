...
def main():
  ...
  parser.add_argument('-m', '--model', default='cnn_IntegerQuantization_edgetpu.tflite',
                      help='File path of .tflite file.')
  parser.add_argument('-i', '--input', default='dog.jpg',
                      help='Image to be classified.')
  parser.add_argument('-l', '--labels', default='animal_labels.txt',
