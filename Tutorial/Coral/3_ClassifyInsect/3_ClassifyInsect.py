...
def main():
  ...
  parser.add_argument('-m', '--model', default='mobilenet_v2_1.0_224_inat_insect_quant_edgetpu.tflite',
                      help='File path of .tflite file.')
  parser.add_argument('-i', '--input', default='lady-bug.jpeg',
                      help='Image to be classified.')
  parser.add_argument('-l', '--labels', default='inat_insect_labels.txt',
